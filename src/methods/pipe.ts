...
export default function pipe<T1>(): Pipe<T1, T1>;
export default function pipe<T1, T2>(
  first: (a: T1) => OrPromiseLike<T2>
): Pipe<T1, T2>;
export default function pipe<T1, T2, T3>(
  first: (a: T1) => OrPromiseLike<T2>,
  second: (a: T2) => OrPromiseLike<T3>
): Pipe<T1, T3>;
export default function pipe<T1, T2, T3, T4>(
  first: (a: T1) => OrPromiseLike<T2>,
  second: (a: T2) => OrPromiseLike<T3>,
  third: (a: T3) => OrPromiseLike<T4>
): Pipe<T1, T4>;
export default function pipe<T1, T2, T3, T4, T5>(
  first: (a: T1) => OrPromiseLike<T2>,
  second: (a: T2) => OrPromiseLike<T3>,
  third: (a: T3) => OrPromiseLike<T4>,
  fourth: (a: T4) => OrPromiseLike<T5>
): Pipe<T1, T5>;
export default function pipe<T1, T2, T3, T4, T5, T6>(
  first: (a: T1) => OrPromiseLike<T2>,
  second: (a: T2) => OrPromiseLike<T3>,
  third: (a: T3) => OrPromiseLike<T4>,
  fourth: (a: T4) => OrPromiseLike<T5>,
...
export default function pipe<T1, T2, T3, T4, T5, T6, T7>(
  first: (a: T1) => OrPromiseLike<T2>,
  second: (a: T2) => OrPromiseLike<T3>,
  third: (a: T3) => OrPromiseLike<T4>,
  fourth: (a: T4) => OrPromiseLike<T5>,
